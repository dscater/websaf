    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {{ Form::select(
                ...
                null,
                ['class' => 'form-control', 'required', 'id' => 'pueblo_nacion_otro_select'],
            ) }}
            <br>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {{ Form::select(
                ...
                null,
                ['class' => 'form-control', 'id' => 'select_discapacidad'],
            ) }}
            <br>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            {{ Form::select(
                ...
                null,
                ['class' => 'form-control', 'required', 'id' => 'select_llega'],
            ) }}
            <br>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label>En el medio de transporte señalado ¿Cuál es el tiempo máximo que demora en llegar de su casa a la
                Unidad Educativa o viceversa?</label>
            {{ Form::select(
                'desc_llega',
                [
                    '' => 'Seleccione...',
        ...
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Fecha de Nacimiento*</label>
                        {{ Form::date('fn_tutor', null, ['class' => 'form-control', 'Fecha de Nacimiento']) }}
                    </div>
                </div>
            </div><br>
            <div class="row">
                ...
                <div class="col-md-3">
                    {{ Form::text('d_tutor', null, ['class' => 'form-control', 'placeholder' => 'Domicilio']) }}
                </div>
                <div class="col-md-3">
                    {{ Form::text('cel_tutor', null, ['class' => 'form-control', 'placeholder' => 'Celular']) }}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Fecha de Nacimiento*</label>
                        {{ Form::date('fn_madre', null, ['class' => 'form-control', 'Fecha de Nacimiento']) }}
                    </div>
                </div>
                <div class="col-md-3">
                    {{ Form::select(
            ...
            <div class="row">
                <div class="col-md-3">
                    {{ Form::text('d_madre', null, ['class' => 'form-control', 'placeholder' => 'Domicilio']) }}
                </div>
                <div class="col-md-3">
                    {{ Form::text('cel_madre', null, ['class' => 'form-control', 'placeholder' => 'Celular']) }}
                </div>
            </div>
        </div>
    </div>
