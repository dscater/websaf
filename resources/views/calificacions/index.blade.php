                            ...
                            <div class="col-md-3 col-sm-6 mr-auto">
                                <div class="form-group">
                                    ...
                                    {{Form::select('trimestre',[
                                        ...
                                        '2' => '2do Trimestre',
                                        '3' => '3er Trimestre',
                                    ],date('Y'),['class'=>'form-control','required','id'=>'select_trimestre'])}}
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-bordered tabla_calificacions">
                                    <thead>
                                        <tr class="bg-blue">
                                            ...
                                            <th rowspan="2" class="bg-orange vertical"><div>PROMEDIO FINAL</div></th>
                                        </tr>
                                        <tr>
                                            <th>
                                            ...
                                            <th>A5</th>
                                            <th>A6</th>
                                            <th class="bg-lightblue vertical"><div>PROMEDIO</div></th>
                                            <th>A1</th>
                                            <th>A2</th>
                                            <th>A3</th>
                                            <th>A4</th>
