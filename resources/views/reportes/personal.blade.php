...
<body>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                <td>{{$cont++}}</td>
                <td>{{$administrativo->paterno}} {{$administrativo->materno}} {{$administrativo->nombre}}</td>
                <td class="img_celda"><img src="{{asset('imgs/users/'.$administrativo->foto)}}" alt="Foto"></td>
                ...
                <td>{{$administrativo->zona}} {{$administrativo->avenida}} {{$administrativo->nro}}</td>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="img_celda"><img src="{{asset('imgs/users/'.$profesor->foto)}}" alt="Foto"></td>
