...
<body>
    ...
    @foreach ($inscripcions as $inscripcion)
        <table>
            <tr>
                <td class="foto" rowspan="4"><img src="{{ asset('imgs/users/' . $inscripcion->estudiante->foto) }}"
                        alt=""></td>
            ...
            <tr>
                <td colspan="2">Apellidos y Nombres: {{ $inscripcion->estudiante->paterno }}
                    {{ $inscripcion->estudiante->materno }} {{ $inscripcion->estudiante->nombre }}</td>
            </tr>
        </table>
        <br><br>
