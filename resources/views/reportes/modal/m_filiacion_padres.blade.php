<div class="modal fade" id="m_filiacion_padres">
    <div class="modal-dialog">
        <div class="modal-content  bg-sucess">
            <div class="modal-header">
                <h4 class="modal-title">Filación del Padre o Tutor</h4>
            ...
            <div class="modal-body">
                {!! Form::open([
                    'route' => 'reportes.filiacion_padres',
                    'method' => 'get',
                    'target' => '_blank',
                    'id' => 'formfiliacion_padres',
                ]) !!}
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn btn-info" id="btnfiliacion_padres">Generar reporte</button>
                {!! Form::close() !!}
            </div>
        </div>
        <!-- /.modal-content -->
