<div class="modal fade" id="m_kardex_desempenos">
    <div class="modal-dialog">
        <div class="modal-content  bg-sucess">
            <div class="modal-header">
                <h4 class="modal-title">Kardex de desempeño académico</h4>
            ...
            <div class="modal-body">
                {!! Form::open([
                    'route' => 'reportes.kardex_desempenos',
                    'method' => 'get',
                    'target' => '_blank',
                    'id' => 'formkardex_desempenos',
                ]) !!}
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn btn-info" id="btnkardex_desempenos">Generar reporte</button>
                {!! Form::close() !!}
            </div>
        </div>
        <!-- /.modal-content -->
