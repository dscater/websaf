<div class="modal fade" id="m_estadistica_estudiantes">
    <div class="modal-dialog">
        <div class="modal-content  bg-sucess">
            <div class="modal-header">
                <h4 class="modal-title">Estadística de Estudiantes</h4>
            ...
            <div class="modal-body">
                {!! Form::open([
                    'route' => 'reportes.estadistica_estudiantes',
                    'method' => 'get',
                    'target' => '_blank',
                    'id' => 'formestadistica_estudiantes',
                ]) !!}
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn btn-info" id="btnestadistica_estudiantes">Generar reporte</button>
                {!! Form::close() !!}
            </div>
        </div>
        <!-- /.modal-content -->
